  ...
  return (
    <section className="flex flex-col gap-8 items-center justify-center p-5 mt-10">
      ...
      <div className="mt-10 grid gap-8 px-4 md:grid-cols-3">
        {TechCards.map((tech) => (
          <div className="transition-all duration-300 sombra-normal border-light-200 bg-[#08122e] dark:border-dark-200 dark:bg-dark-100 relative flex flex-col rounded-2xl p-6 backdrop-blur-lg box-light dark:box-light h-46 items-center hover:[--icon-color:white]">
            ...
            <p className="text-sm text-light-900 group-hover:text-light-50 dark:text-dark-900 group-hover:dark:text-dark-950 transition">
              {tech.description}
            </p>
          </div>
        ))}
